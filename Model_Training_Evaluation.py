...
path_figures_M1 = os.path.join(Figures_dir_M1, 'Mod_1')
...
hist_df_M4.to_csv(path_figures_M4 + 'history.csv')
...
# model_4 = tf.keras.models.load_model('D:/Eydoouk/Eydoo_Searches/Hypouses approval/HYPO model 1 10000 Images 3 sets/vgg16_4_650F.h5')
# Mod 4 Vs ts4, tr4
